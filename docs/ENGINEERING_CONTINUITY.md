...
## Ecosystem position
 Citation-first provenance-aware RAG

## Current mission
Trustworthy retrieval layer: produces ranked evidence with provenance and deterministic fingerprints so generated answers can be grounded and audited.
